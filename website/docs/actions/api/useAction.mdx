...
| callbacks | [Callbacks](#callbacks)                        | The configuration for the action. |
...
| ------ | ------------------------------- | ----------------------------------- |
| state  | [State](#state)                 | The state of the action.            |
| run    | `(payload: P) => Promise<void>` | The function to execute the action. |
